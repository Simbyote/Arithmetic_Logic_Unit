...
from one another and avoid any mismatches in the timing of the inputs.
...
the \textit{posedge reset} block. This is to ensure that the output registers are properly initialized before the operation begins.

...
\subsection{Clock Signal Implementation}
\subsection{Addition Timing Mismatch}
\subsection{Refactoring Division Operation}

\section{Potential Improvements}
\subsection{Adding Negative Number Support}
\subsection{Adding Floating Point Support}
\subsection{Refactoring Multiplier and Divider Controllers}
\subsubsection*{Implementations Closer to Real Hardware}
\subsection{Adding Additional Operations}

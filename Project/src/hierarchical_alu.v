 ...
 */
module Hierarchical_ALU #( parameter WIDTH ) (
 ...
 */
module Addition_Control #( parameter WIDTH ) (
    input wire clk,
    input wire reset,
    input wire start,
    input wire [ WIDTH-1:0 ] in1,
    ...
    generate
        if ( ( WIDTH <= 0) || ( WIDTH > 256 ) ) begin: invalid_width
            initial begin
                $fatal(1,
                "Error: Invalid WIDTH value (%0d). Must be between 1 and 256", WIDTH );
            end
        end else begin: valid_width
            // FSM states
            localparam [ 1:0 ] 
                INIT = 2'b00,
                STEP = 2'b01,
 ...
 */
module Subtraction_Control #( parameter WIDTH ) (
    input wire clk,
    input wire reset,
    input wire start,
    input wire [ WIDTH-1:0 ] in1,
 ...
 */
module Multiplier_Control #( parameter WIDTH ) (
    input wire clk,
    input wire reset,
    input wire start,
    input wire [ WIDTH-1:0 ] in1,
 ...
 */
module Divider_Control #( parameter WIDTH ) (
    input wire clk,
    input wire reset,
    input wire start,
    input wire [ WIDTH-1:0 ] in1,

 ...
 */ 
module Signal_Decomposition #( parameter WIDTH = 0 ) (
 ...
 */
module Signal_Alignment #( parameter WIDTH = 0 ) (
 ...
 */
module Divider_Core #( parameter WIDTH = 0 ) (
    input wire [ WIDTH-1:0 ] in1,
    input wire [ WIDTH-1:0 ] in2,
    output wire [ WIDTH-1:0 ] out,
 ...
 */
module Divider #( parameter WIDTH ) (
    input wire [ WIDTH-1:0 ] in1,
    input wire [ WIDTH-1:0 ] in2,
    output wire [ WIDTH-1:0 ] out,
    output wire [ WIDTH-1:0 ] remainder
